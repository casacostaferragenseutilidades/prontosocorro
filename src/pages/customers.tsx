...
import { useListCustomers, useCreateCustomer, useDeleteCustomer, getListCustomersQueryKey } from "@/lib/api";
import { formatCurrency } from "@/lib/utils";
import { Search, Plus, Users, ChevronRight, X, UserPlus, Phone, Mail, MapPin, AlertTriangle, DollarSign, Loader2 } from "lucide-react";
  ...
  const handleCreate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await createMutation.mutateAsync({
        ...
        payment_method: (formData.get("paymentMethod") as any) || 'money',
      });
              ...
              >
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
                  <div>
                    ...
                    <p className={`font-bold text-lg mt-1 ${customer.totalDebt > 0 ? "text-red-600" : "text-green-600"}`}>
