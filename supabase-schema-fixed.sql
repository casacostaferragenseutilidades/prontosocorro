-- Schema SQL para Supabase - Sistema Financeiro Venda Varejo (Versão Corrigida)
...
-- Apagar triggers existentes antes de criar novos
...
-- Apagar políticas existentes antes de criar novas
...
DROP POLICY IF EXISTS "Users can update sale_items" ON sale_items;
DROP POLICY IF EXISTS "Users can delete sale_items" ON sale_items;

DROP POLICY IF EXISTS "Users can view all accounts_payable" ON accounts_payable;
DROP POLICY IF EXISTS "Users can insert accounts_payable" ON accounts_payable;
DROP POLICY IF EXISTS "Users can update accounts_payable" ON accounts_payable;
DROP POLICY IF EXISTS "Users can delete accounts_payable" ON accounts_payable;

DROP POLICY IF EXISTS "Users can view all accounts_receivable" ON accounts_receivable;
DROP POLICY IF EXISTS "Users can insert accounts_receivable" ON accounts_receivable;
DROP POLICY IF EXISTS "Users can update accounts_receivable" ON accounts_receivable;
DROP POLICY IF EXISTS "Users can delete accounts_receivable" ON accounts_receivable;

DROP POLICY IF EXISTS "Users can view all cash_flow_entries" ON cash_flow_entries;
DROP POLICY IF EXISTS "Users can insert cash_flow_entries" ON cash_flow_entries;
DROP POLICY IF EXISTS "Users can update cash_flow_entries" ON cash_flow_entries;
DROP POLICY IF EXISTS "Users can delete cash_flow_entries" ON cash_flow_entries;
...
-- Apagar função existente antes de criar
